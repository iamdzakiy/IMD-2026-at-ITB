...
async function main() {
  ...
  const omm = await prisma.competition.upsert({
    ...
    update: {
      ...
      preliminaryStart: wib('2026-07-01T00:00:00'),
      preliminaryDeadline: wib('2026-08-10T23:59:59'),
      semifinalStart: wib('2026-08-15T00:00:00'),
      semifinalDeadline: wib('2026-08-22T23:59:59'),
      finalStart: wib('2026-08-25T00:00:00'),
      finalDeadline: wib('2026-08-29T23:59:59'),
      grandFinalDate: wib('2026-08-31T00:00:00'),
  ...
  const nec = await prisma.competition.upsert({
    ...
    update: {
      ...
      registrationDeadline: wib('2026-07-31T23:59:59'),
      preliminaryStart: wib('2026-07-01T00:00:00'),
      preliminaryDeadline: wib('2026-08-05T23:59:59'),
      semifinalStart: wib('2026-08-11T00:00:00'),
      semifinalDeadline: wib('2026-08-18T23:59:59'),
      finalStart: wib('2026-08-23T00:00:00'),
      finalDeadline: wib('2026-08-28T23:59:59'),
      grandFinalDate: wib('2026-08-31T00:00:00'),
  ...
  const superAdmin = await prisma.admin.upsert({
    ...
    create: {
      username: 'superadmin',
      email: 'fadzaro10@gmail.com', // ✅ fixed email
