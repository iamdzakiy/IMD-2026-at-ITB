...
export const metadata: Metadata = {
  ...
  generator: 'Next.js',
  category: 'Events',
  applicationName: 'IMD 2026 at ITB',
  ...
  metadataBase: new URL('https://imd2026.vercel.app/'),
  verification: {
    google: 'GNYbAgsMCZ49BqBiEJz5TQE0X3H0XZGtURIryEvrNU8', // Keep your Google verification
  },
  openGraph: {
    title: 'IMD 2026 at ITB',
    description:
      'International Microorganism Day (IMD) 2026 at ITB – Olympiad of Microbiology, Science Project Competition, and National Essay Competition. Join us in exploring the microbial world and driving sustainable innovation.',
